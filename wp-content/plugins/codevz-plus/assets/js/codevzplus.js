/* [CODEVZ] + lightgallery 1.10 + zoom 1.3 + video 1.4 */ ! function(a, b) {
    ...
    ! function() {
        ...
        function b(a, b, c, d) {
            ...
            if (e.core.$slide.eq(b).find(".lg-video").append(e.loadVideo(c, "lg-object", !0, b, d)), d)
                ...
                } else !e.videoLoaded && e.core.s.autoplayFirstVideo && e.core.$slide.eq(b).find(".lg-html5").length && e.core.$slide.eq(b).find(".lg-html5").get(0).play()
        }
...
! function(v) {
    "use strict";
    v.fn.theiaStickySidebar = function(i) {
        function t(i, t) {
            return !0 === i.initialized || !(v("body").width() < i.minWidth) && (o = t, (u = i).initialized = !0, 0 === v("#theia-sticky-sidebar-stylesheet-" + u.namespace).length && v("head").append(v('<style id="theia-sticky-sidebar-stylesheet-' + u.namespace + '">.theiaStickySidebar:after {content: ""; display: table; clear: both;}</style>')), o.each(function() {
                function y() {
                ...
                var o, i = {};
                i.sidebar = v(this), i.options = u || {}, i.container = v(i.options.containerSelector), 0 == i.container.length && (i.container = i.sidebar.parent()), i.sidebar.parents().css("-webkit-transform", "none"), i.sidebar.css({
                    position: i.options.defaultPosition,
                    overflow: "visible",
                    "-webkit-box-sizing": "border-box",
                    "-moz-box-sizing": "border-box",
                    "box-sizing": "border-box"
                }), i.stickySidebar = i.sidebar.find(".theiaStickySidebar"), 0 == i.stickySidebar.length && (o = /(?:text|application)\/(?:x-)?(?:javascript|ecmascript)/i, i.sidebar.find("script").filter(function(i, t) {
                    return 0 === t.type.length || t.type.match(o)
                }).remove(), i.stickySidebar = v("<div>").addClass("theiaStickySidebar").append(i.sidebar.children()), i.sidebar.append(i.stickySidebar)), i.marginBottom = parseInt(i.sidebar.css("margin-bottom")), i.paddingTop = parseInt(i.sidebar.css("padding-top")), i.paddingBottom = parseInt(i.sidebar.css("padding-bottom"));
                var t, e, a, s = i.stickySidebar.offset().top,
                    n = i.stickySidebar.outerHeight();
                i.stickySidebar.css("padding-top", 1), i.stickySidebar.css("padding-bottom", 1), s -= i.stickySidebar.offset().top, n = i.stickySidebar.outerHeight() - n - s, 0 == s ? (i.stickySidebar.css("padding-top", 0), i.stickySidebarPaddingTop = 0) : i.stickySidebarPaddingTop = 1, 0 == n ? (i.stickySidebar.css("padding-bottom", 0), i.stickySidebarPaddingBottom = 0) : i.stickySidebarPaddingBottom = 1, i.previousScrollTop = null, i.fixedScrollTop = 0, y(), i.onScroll = function(i) {
                    if (i.stickySidebar.is(":visible")) {
                        if (v("body").width() < i.options.minWidth) return void y();
                        if (i.options.disableOnResponsiveLayouts)
                            if (i.sidebar.outerWidth("none" == i.sidebar.css("float")) + 50 > i.container.width()) return void y();
                        var t, o, e, a, s, n, d, r, c, p, b, l, h, g = v(document).scrollTop(),
                            f = "static";
                        g >= i.sidebar.offset().top + (i.paddingTop - i.options.additionalMarginTop) && (t = i.paddingTop + u.additionalMarginTop, o = i.paddingBottom + i.marginBottom + u.additionalMarginBottom, e = i.sidebar.offset().top, a = i.sidebar.offset().top + (S = i.container, m = S.height(), S.children().each(function() {
                            m = Math.max(m, v(this).height())
                        }), m), s = 0 + u.additionalMarginTop, n = i.stickySidebar.outerHeight() + t + o < v(window).height() ? s + i.stickySidebar.outerHeight() : v(window).height() - i.marginBottom - i.paddingBottom - u.additionalMarginBottom, d = e - g + i.paddingTop, r = a - g - i.paddingBottom - i.marginBottom, c = i.stickySidebar.offset().top - g, p = i.previousScrollTop - g, "fixed" == i.stickySidebar.css("position") && "modern" == i.options.sidebarBehavior && (c += p), "stick-to-top" == i.options.sidebarBehavior && (c = u.additionalMarginTop), "stick-to-bottom" == i.options.sidebarBehavior && (c = n - i.stickySidebar.outerHeight()), c = 0 < p ? Math.min(c, s) : Math.max(c, n - i.stickySidebar.outerHeight()), c = Math.max(c, d), c = Math.min(c, r - i.stickySidebar.outerHeight()), f = !(b = i.container.height() == i.stickySidebar.outerHeight()) && c == s || !b && c == n - i.stickySidebar.outerHeight() ? "fixed" : g + c - i.sidebar.offset().top - i.paddingTop <= u.additionalMarginTop ? "static" : "absolute"), "fixed" == f ? (l = v(document).scrollLeft(), i.stickySidebar.css({
                            position: "fixed",
                            width: k(i.stickySidebar) + "px",
                            transform: "translateY(" + c + "px)",
                            left: i.sidebar.offset().left + parseInt(i.sidebar.css("padding-left")) - l + "px",
                            top: "0px"
                        })) : "absolute" == f ? (h = {}, "absolute" != i.stickySidebar.css("position") && (h.position = "absolute", h.transform = "translateY(" + (g + c - i.sidebar.offset().top - i.stickySidebarPaddingTop - i.stickySidebarPaddingBottom) + "px)", h.top = "0px"), h.width = k(i.stickySidebar) + "px", h.left = "", i.stickySidebar.css(h)) : "static" == f && y(), "static" != f && 1 == i.options.updateSidebarHeight && i.sidebar.css({
                            "min-height": i.stickySidebar.outerHeight() + i.stickySidebar.offset().top - i.sidebar.offset().top + i.paddingBottom
                        }), i.previousScrollTop = g
                    }
                    var S, m
                }, i.onScroll(i), v(document).on("scroll." + i.options.namespace, (a = i, function() {
                    a.onScroll(a)
                })), v(window).on("resize." + i.options.namespace, (e = i, function() {
                    e.stickySidebar.css({
                        position: "static"
                    }), e.onScroll(e)
                })), "undefined" != typeof ResizeSensor && new ResizeSensor(i.stickySidebar[0], (t = i, function() {
                    t.onScroll(t)
                }))
            }), !0);
            var u, o
        ...
        return (i = v.extend({
            ...
            namespace: "TSS"
        }, i)).additionalMarginTop = parseInt(i.additionalMarginTop) || 0, i.additionalMarginBottom = parseInt(i.additionalMarginBottom) || 0, t(o = i, e = this) || (console.log("TSS: Body width smaller than options.minWidth. Init is delayed."), v(document).on("scroll." + o.namespace, (n = o, d = e, function(i) {
            t(n, d) && v(this).unbind(i)
        })), v(window).on("resize." + o.namespace, (a = o, s = e, function(i) {
            t(a, s) && v(this).unbind(i)
        }))), this
    }
}(jQuery);
    ...
    return {
        ...
        backtotop: function() {
            ...
            body.on('click', 'div.fixed_contact', function(e) {
                ...
                !$(e.target).hasClass('fa-cog') && $('html, body').animate({
                    scrollTop: 0
                }, 1200, 'easeInOutCodevz');
